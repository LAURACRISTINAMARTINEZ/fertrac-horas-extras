...
if input_file and empleados_file and porcentaje_file and turnos_file:
    ...
    # ============================================================================
    def obtener_factor_con_dia(tipo_base, dia_num):
        """
        Retorna el factor correcto según el tipo de hora extra y el día de la semana.
        Si es domingo (dia_num == 6), busca primero el factor dominical.
        Si no existe el factor dominical en el archivo, cae al factor normal como respaldo.
        """
    ...
    # ============================================================================
    # COLUMNA DE AUDITORÍA: indica si se aplicó tarifa dominical o normal
    # ============================================================================
    df["TIPO TARIFA"] = df["DIA_NUM"].apply(lambda d: "DOMINICAL" if d == 6 else "NORMAL")
    ...
    - **Horas extra diurnas DOMINGO:** Factor {factor_map.get("EXTRA DIURNA DOMINICAL", 2.00)} ✅
    - **Horas extra nocturnas DOMINGO:** Factor {factor_map.get("EXTRA NOCTURNA DOMINICAL", 2.50)} ✅
    - **Recargo nocturno DOMINGO:** Factor {factor_map.get("RECARGO NOCTURNO DOMINICAL", 1.75)} ✅
